<template>
    ...
    <form class="max-w-md mx-auto mt-10">
        ...
        <div class="flex justify-center">
            <button type="submit" class=" mt-12 pl-12 pr-12 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
        </div>
  </form>
